...
\lstinputlisting[language=R, breaklines=true]{../knn.R}
\newpage
\lstinputlisting[language=R, breaklines=true]{../visualizations.R}
\newpage
\lstinputlisting[language=R, breaklines=true]{../map.R}
\end{document}
